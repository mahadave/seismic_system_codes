...
#define adc_CFG1_COUNTS_PER_VOLT    (5333u)
#define adc_CFG1_IDEAL_DEC_GAIN     (0x814Au)

#define adc_CFG1_IDEAL_ODDDEC_GAIN  (0x8000u)

/* Input and DAC Cap values in pF */
#define adc_CFG1_IPCAP1VALUE        (0x03E0u)
#define adc_CFG1_DACAPVALUE         (0x1770u)
